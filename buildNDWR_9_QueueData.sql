CREATE  PROCEDURE `buildNDWR_9_QueueData`(IN selectedMFLCode INT)
BEGIN
  DECLARE n INT DEFAULT 0;
         ...
         delete from ndwr_baseline_queue_9 where person_id in(select patientid from ndwr.ndwr_base_line);
		 SELECT count(*) from ndwr_baseline_queue_9  INTO n;
  ...
  delete from ndwr_baseline_queue_9;             
