...
CREATE TABLE IF NOT EXISTS ndwr.ndwr_patient_eac (
    ...
    `MMSA4_4` DOUBLE NULL,
    `MMSAScore` DOUBLE NULL,
    `EACRecievedVL` TINYINT NULL,
    `EACVL` VARCHAR(50) NULL,
    `EACVLConcerns` TEXT NULL,
    `EACVLThoughts` TEXT NULL,
    `EACWayForward` TEXT NULL,
    `EACCognitiveBarrier` TEXT NULL,
    `EACBehaviouralBarrier_1` TEXT NULL,
    `EACBehaviouralBarrier_2` TEXT NULL,
    `EACBehaviouralBarrier_3` TEXT NULL,
    `EACBehaviouralBarrier_4` TEXT NULL,
    `EACBehaviouralBarrier_5` TEXT NULL,
    `EACEmotionalBarriers_1` TEXT NULL,
    `EACEmotionalBarriers_2`TEXT NULL,
    `EACEconBarrier_1` BOOLEAN NULL,
    `EACEconBarrier_2` TEXT NULL,
    `EACEconBarrier_3` TEXT NULL,
    ...
    `EACReviewImprovement` TEXT NULL,
    `EACReviewMissedDoses` TEXT NULL,
    `EACReviewStrategy` TEXT NULL,
    `EACReferral` BOOLEAN NULL,
    `EACReferralApp` BOOLEAN NULL,
    `EACReferralExperience` TEXT NULL,
    `EACHomevisit` BOOLEAN NULL,
    `EACAdherencePlan` TEXT NULL,
    `EACFollowupDate` TEXT NULL,
