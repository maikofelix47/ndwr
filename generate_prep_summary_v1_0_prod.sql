CREATE  PROCEDURE `generate_prep_summary_v1_0_prod`(IN query_type varchar(50), IN queue_number int, IN queue_size int, IN cycle_size int , IN log boolean)
BEGIN

					select @start := now();
					select @table_version := "flat_prep_summary_v1.0";
                    set @primary_table := "flat_prep_summary";
					...
					CREATE TABLE IF NOT EXISTS `flat_prep_summary` (
                    ...
                    CREATE TABLE IF NOT EXISTS `prep_weekly_report_dataset` (
...
-- 							end as prep_start_date_branch,
                        ...
                        replace into flat_prep_summary
						(select
							*
						...
						(SELECT
                         ...
                         replace into prep_weekly_report_dataset
						(select
							*
